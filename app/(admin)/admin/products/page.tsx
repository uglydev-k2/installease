      ...
      <div className="flex flex-col gap-3 rounded-2xl border bg-white p-4 shadow-sm dark:border-slate-800 dark:bg-slate-900 md:flex-row md:items-center">
        <div className="relative flex-1">
          ...
          <input
            ...
            className="w-full rounded-xl border border-slate-200 py-2.5 pl-10 pr-3 text-sm outline-none focus:ring-2 focus:ring-brand-accent dark:border-slate-700 dark:bg-slate-950"
          />
        </div>
